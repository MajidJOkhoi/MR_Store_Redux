    ...
    <div className="mx-4 my-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="p-4 bg-white shadow-lg shadow-gray-300 rounded-md">
          ...
          <p className="text-gray-600 text-sm">Shipping: $0.00</p>
          <p className="text-gray-800 font-bold text-lg mt-2">
            The total amount of (excluding VAT): ${totalAmount.toFixed(2)}
          </p>
          <button className="mt-4 w-full bg-blue-500 text-white py-2 rounded-md hover:bg-blue-600 transition duration-300" onClick={handleCheckout}>
            Go to Checkout
          </button>
        </div>
      </div>
